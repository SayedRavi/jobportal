        ...
        <div class="row">
            ...
            <div class="company-profile">
                ...
                @elseif(\Illuminate\Support\Facades\Auth::user()->company->cover_photo)
                    <div class="cover-container">
                    <img  src="{{asset('uploads/cover_photo')}}/{{\Illuminate\Support\Facades\Auth::user()->company->cover_photo}}" alt="" width="100%" height="50%" class="img-fluid center">
                    </div>
                        @endif
            </div>
            <div class="company-desc">
                ...
                @else
                    <img  src="{{asset('uploads/logo')}}/{{auth()->user()->company->logo}}" alt="" width="200px" class="img-fluid center @error('logo') valid @enderror">
                @endif
                <h1>{{$company->cname}}</h1>
