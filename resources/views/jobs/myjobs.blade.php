                            ...
                            @php $i=1 @endphp
                                @foreach($jobs as $job)
                                        ...
                                        <tr>
                                            ...
                                            <td><a style="text-decoration: none; color: black" href="{{route('jobs.show',[$job->id,$job->slug])}}"><a href="{{route('jobs.editjobs',[$job->id,$job->slug])}}"><button class="btn btn-warning btn-small">Edit</button></a>
                                            <a style="text-decoration: none; color: black" href="{{route('jobs.show',[$job->id,$job->slug])}}"><a href="{{route('jobs.show',[$job->id,$job->slug])}}"><button class="btn btn-success btn-small">Details</button></a></td>
                                        </tr>
                                @endforeach
