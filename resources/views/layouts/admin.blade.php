                        ...
                        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                            ...
                            <div class="position-sticky">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link {{$active == 'dashboard' ? 'active' : ''}}" aria-current="page" href="{{route('admin.index')}}">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{$active == 'users' ? 'active' : ''}}" aria-current="page" href="{{route('admin.users')}}">
                                            <i class="fa fa-user-friends"></i>
                                            <span class="ml-2">Users</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{$active == 'company' ? 'active' : ''}}" aria-current="page" href="{{route('admin.company.view')}}">
                                            <i class="fa fa-home"></i>
